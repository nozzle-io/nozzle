...
Result<mapped_pixels> lock_frame_pixels(const frame &) {
    return Error{ErrorCode::NotImplemented, "lock_frame_pixels not implemented on this platform"};
}

void unlock_frame_pixels(const frame &) {}

Result<mapped_pixels> lock_writable_pixels(writable_frame &) {
    return Error{ErrorCode::NotImplemented, "lock_writable_pixels not implemented on this platform"};
}
